...
export class SeguridadService {
  ...
  sessionUserData = new BehaviorSubject<UsuarioModelo>(new UsuarioModelo()); //esta variable se actualiza todo el tiempo, guarda los datos del usuario
  ...
  //gestionar los datos del usuario con los siguientes métodos
